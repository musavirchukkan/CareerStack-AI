...
*The users will eventually receive these updates bundled together during the very next `fix:` or `feat:` release.*
...
Sometimes you might update an insecure package dependency (`chore:`) and you need users to get that update *immediately*, rather than waiting for the next feature release.
